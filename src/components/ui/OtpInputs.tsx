    ...
    <motion.div animate={controls} className="flex justify-center gap-2 sm:gap-3">
      {Array.from({ length }).map((_, i) => (
        <input
          ...
          onPaste={handlePaste}
          className={`h-12 w-11 rounded-xl border bg-surface-2 text-center font-nunito text-lg font-semibold text-ink outline-none transition focus:ring-2 focus:ring-brand/40 sm:h-14 sm:w-12 ${
