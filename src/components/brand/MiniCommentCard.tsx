    ...
    <div className={`relative ml-3 w-full ${className}`}>
      ...
      <div className="rounded-2xl rounded-tl-none bg-surface-2 p-3 shadow-xl ring-1 ring-black/5">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-brand-light"></div>
          <div className="min-w-0 flex-1">
            <p className="truncate font-nunito text-[12px] font-semibold leading-tight text-ink">
              {name}
            </p>
        ...
        <p className="mt-1.5 font-nunito text-[12px] leading-snug text-ink">
          {text}
        </p>
        <div className="mt-1.5 flex items-center gap-1">
          <Heart
            className={`h-3 w-3 ${reacted ? "fill-danger text-danger" : "text-muted"}`}
          />
